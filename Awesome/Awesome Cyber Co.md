...
What are the most critical cybersecurity threats facing organizations in 2025?
How can CISOs prioritize risk mitigation in their cybersecurity projects?
What role does AI play in transforming industries and what are the security implications?
How can organizations secure AI deployments and related data?
What is third-party risk management and why is it essential for cybersecurity?
Ask a question
...
2–AppSec: The Key to Secure Applications— The AppSec repository is a curated list of resources for learning about application security.

None
Awesome AppSec GitHub
3–Discovering Assets: The First Step in Cybersecurity — The Asset Discovery repository provides a comprehensive list of tools and resources for discovering assets in cybersecurity.

None
Awesome Asset Discovery GitHub
4 — The Bounty Hunter: A Guide to Bug Bounties — The Bug Bounty repository is a collection of bug bounty resources, including platforms, tools, and write-ups.

None
Awesome Bug Bounty GitHub
5–Capsulecorp Pentest: A Virtual Network for Pentesters — The Capsulecorp Pentest repository provides a Vagrant virtual network that is preloaded with vulnerable apps and systems.

None
Capsuloecorp Pentest GitHub
6 — Mastering CTF: A Journey Through Capture The Flag Challenges — The CTF repository is a collection of Capture The Flag (CTF) challenges, tools, resources, and more.

None
Awesome CTF GitHub
7–Cyber Skills: Building Your Cybersecurity Toolkit — The Cyber Skills repository is a curated list of resources for learning and improving cybersecurity skills.

None
Awesome Cyber Skills GitHub
8–DevSecOps: Integrating Security into DevOps— The DevSecOps repository provides a list of useful resources for integrating security into DevOps practices.

None
Awesome DevSecOps GitHub
9–Embedded and IoT Security: Securing the Future of Technology — The Security of embedded systems and IoT repository is a curated list of awesome resources about the security of embedded systems and the Internet of Things.

None
Awesome Embedded and IoT Security GitHub
...
Kaspersky: Renowned for its antivirus and endpoint protection solutions.

Trellix: Integrated threat intelligence and incident response.

Perimeter 81: Simplified network security with zero trust architecture.

CrowdStrike: Endpoint protection and threat intelligence.

McAfee: Comprehensive cybersecurity solutions for consumers and businesses.

CyberArk: Leader in identity security and privileged access management.

Imperva: Data and application security across multi-cloud environments.

Proofpoint: Protects organizations from advanced email threats.

F5 Networks: Application delivery and multi-cloud security solutions.

Rapid7: Provides vulnerability management and threat detection.

ESET: Strong antivirus and endpoint security solutions.

Nord Security: Known for its VPN and secure internet access.
...
Blackberry: Mobile security and endpoint management.
...
Keeper Security: Password management and secure vault.

Pentera: Automated penetration testing and vulnerability management.
...
9. Tenable (Nessus)
Nessus cybersecurity companies
...
14. Rapid7
Rapid7 - cybersecurity companies
...
18. Sciencesoft
Sciencesoft Dashboard penetration testing tool cybersecurity companies
...
19. Arctic Wolf
Arctic wolf network - cybersecurity companies
...
Customers and Accolades: GPC, St. John’s University, RJ O’Brien, 2024 Global Infosec Awards – Cyber Defense Magazine, 2023 LinkedIn Top Startups USA
Pros
...
41. Veracode
veracode cybersecurity companies
Founded year: 2006
